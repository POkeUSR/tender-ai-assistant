...
class DocumentNotFoundError(AppException):
    ...
    def __init__(self, doc_id: str = None):
        message = f"Документ не найден" if doc_id is None else f"Документ {doc_id} не найден"
...
class DocumentNotReadyError(AppException):
    ...
    def __init__(self, doc_id: str = None):
        message = "Документ еще обрабатывается" if doc_id is None else f"Документ {doc_id} еще обрабатывается"
